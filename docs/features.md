...
> 版本 0.2.0 · 代码基线 `main@f027013` · 最后更新 2026-09
...
- **字体与字号**：设置中可配置字体族（默认 Cascadia Mono 栈）、字号（8–40，默认 13）；字体/字号**立即热应用**到所有已打开的终端会话（不触发 PTY 重建）；终端内 `Ctrl/Cmd + 滚轮` 缩放字号（受设置 `终端.Ctrl+滚轮缩放` 开关控制，默认开）。
...
- 顶部栏右侧按钮切换右侧栏；面板为 **搜索 / 引用 / 大纲 / 问题** 四标签，宽度可拖拽（源代码管理已于 Phase 3.1 移入**左侧主栏** §8.1）。
...
- **入口**：活动栏「源代码管理」按钮打开**左侧主栏**「源代码管理」视图；已打开时再点一次收起面板。
